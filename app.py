...
def deposit():
    ...
    if request.method == "POST":
        ...
        flash(f"Successfully deposited ZAR{amount:.2f}.")
...
def withdraw():
    ...
    if request.method == "POST":
        ...
        flash(f"Successfully withdrew ZAR{amount:.2f}.")
        return redirect("/dashboard")
...
def transfer():
    ...
    if request.method == "POST":
        ...
        flash(f"Successfully transferred ZAR{amount:.2f} to {recipient_username}.")
        return redirect("/dashboard")
...
def send_money():
    ...
    if request.method == "POST":
        ...
        flash(
            f"Successfully transferred ZAR{amount:.2f} to external account '{external_account}' with a ZAR{transaction_fee:.2f} fee.")
        return redirect("/dashboard")
...
def create_account():
    ...
    if request.method == "POST":
        ...
        flash(f"Account '{account_name}' created successfully with an initial balance of ZAR{initial_balance:.2f}.")
